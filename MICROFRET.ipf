...
// CHANGE THESE FOR EACH INSTRUMENT: USE XTALK_AUTOF SCRIPT
variable autodonor=0.2690965		// Autofluorescence in the donor channel (channel A)- i.e. average intensity from buffer.
variable autoacceptor=0.33032593	// Autofluorescence in acceptor channel (B). 
variable crosstalk=0.11802155		// Crosstalk- i.e. some donor intensity passes into acceptor channel- this is decimal
